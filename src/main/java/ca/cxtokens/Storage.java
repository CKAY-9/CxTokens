...
public class Storage {
    ...
    public static void initializeData() {
        try {
            ...
            if (!config.isSet("config.logging")) {
                config.set("config.logging", false);
            }
            ...
            if (!config.isSet("achievements.custom")) {
                config.set(
                    "achievements.custom.story/enter_the_end.minReward",
                    1000L
                );
                config.set(
                    "achievements.custom.story/enter_the_end.maxReward",
                    2000L
                );
            }
            ...
            if (!storeItems.isSet("items")) {
                Item exampleCustom = new Item(
                    new ItemStack(Material.IRON_SWORD),
                    50000,
                    0
                );
                storeItems.set(
                    "items.customItemWithEnchantAndName.material",
                    exampleCustom.stack.getType().getKey().toString()
                );
                storeItems.set(
                    "items.customItemWithEnchantAndName.amount",
                    exampleCustom.stack.getAmount()
                );
                storeItems.set(
                    "items.customItemWithEnchantAndName.price",
                    exampleCustom.price
                );
                storeItems.set(
                    "items.customItemWithEnchantAndName.sellMultiplier",
                    exampleCustom.sellMultiplier
                );
                storeItems.set(
                    "items.customItemWithEnchantAndName.enchants.sharpness.enchant",
                    "minecraft:sharpness"
                );
                storeItems.set(
                    "items.customItemWithEnchantAndName.enchants.sharpness.level",
                    5
                );
                storeItems.set(
                    "items.customItemWithEnchantAndName.customName",
                    "THE SHARP SWORD"
                );
                ...
                Item[] items = new Item[] {
                    ...
                    new Item(
                        new ItemStack(Material.BIRCH_SAPLING, 4),
                        100,
                        0.25
                    ),
                    new Item(new ItemStack(Material.SPRUCE_LOG, 16), 100, 0.5),
                    new Item(
                        new ItemStack(Material.SPRUCE_SAPLING, 4),
                        100,
                        0.25
                    ),
                    new Item(new ItemStack(Material.JUNGLE_LOG, 16), 100, 0.5),
                    new Item(
                        new ItemStack(Material.JUNGLE_SAPLING, 4),
                        100,
                        0.25
                    ),
                    new Item(
                        new ItemStack(Material.DARK_OAK_LOG, 16),
                        100,
                        0.5
                    ),
                    new Item(
                    ...
                    new Item(
                        new ItemStack(Material.ACACIA_SAPLING, 4),
                        100,
                        0.25
                    ),
                    new Item(
                        new ItemStack(Material.MANGROVE_LOG, 16),
                        125,
                        0.5
                    ),
                    new Item(new ItemStack(Material.WARPED_STEM, 16), 150, 0.5),
                    new Item(
                        new ItemStack(Material.CRIMSON_STEM, 16),
                        150,
                        0.5
                    ),
                ...
                for (int i = 0; i < items.length; i++) {
                    ...
                    storeItems.set(
                        "items." + i + ".material",
                        temp.stack.getType().getKey().toString()
                    );
                    storeItems.set(
                        "items." + i + ".amount",
                        temp.stack.getAmount()
                    );
                    storeItems.set("items." + i + ".price", temp.price);
                    storeItems.set(
                        "items." + i + ".sellMultiplier",
                        temp.sellMultiplier
                    );
                }
